...
function DashBoard() {
  return (
    <div className="w-full h-[80px] flex-shrink-0 border-{b}-[1px] border-[#eaecf0] shadow-[0px_1px_4px_0px_rgba(0,0,0,0.08)] flex items-center px-[24px]">
      <h4 className="text-customFontOne text-black non-italic flex-1">
        DashBoard
      </h4>

      <div className="mr-[24px] hover:cursor-pointer">
        <svg
